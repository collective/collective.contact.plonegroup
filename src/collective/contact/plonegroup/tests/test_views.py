...
class TestViews(FunctionalTestCase):
    ...
    def setUp(self):
        ...
        set_registry_functions([{'fct_title': 'Observers', 'fct_id': 'observer', 'fct_orgs': [],
                                 'fct_management': False, 'enabled': True},
                                {'fct_title': 'Director', 'fct_id': 'director', 'fct_orgs': [],
                                 'fct_management': False, 'enabled': True}, ])
    ...
    def test_management_view(self):
        ...
        old_values = ("{{'_groups_': [{{'group': 'investigators', 'user': 'test_user_1_'}}], 'observer': "
        ...
        data = {'_groups_': content._groups_ + [{'group': 'investigators', 'user': 'debra'}],
        ...
        data = {'_groups_': [dic for dic
                             in content._groups_
                             if dic['user'] != 'debra'] + [{'group': 'investigators', 'user': 'dexter'}],
        ...
        data = {'_groups_': content._groups_ + [{'group': 'investigators', 'user': None}],
